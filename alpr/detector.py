...
class PlateDetector:
    ...
    def draw_bboxes(self, frame: np.ndarray, bboxes: list, mostrar_score: bool = False):
        ...
        # Capturar el área del frame correspondiente al rectángulo
        area = frame[y1:y2, x1:x2]
        cv2.putText(area, "Number Plate",cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255, 0, 255), 2)
        # Generar un nombre único para el archivo de la captura
        capture_name = f'plate_{x1}_{y1}_{x2}_{y2}_{score}.jpg'
